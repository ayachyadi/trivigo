...
// Menambahkan onViewLeaderboard ke dalam list destructuring props
export default function MainMenu({ playerData, onLogOut, onSelectPvP, onSelectSolo, onViewLeaderboard }) { 
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4 font-sans">
      ...
      <div className="bg-[#FAFAFA] w-full max-w-[400px] rounded-[2.5rem] shadow-2xl p-5 flex flex-col h-[720px] max-h-[95vh] relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {/* MENGGANTI ICON GEAR MENJADI ICON LEADERBOARD PODIUM */}
          <button 
            onClick={onViewLeaderboard} 
            className="p-2 bg-gray-100 hover:bg-gray-200 rounded-full transition-colors text-gray-600 active:scale-95"
          >
        ...
        <div className="mt-6 bg-[#EDF1F5] rounded-[1.8rem] p-5 flex items-center justify-between h-[85px] mb-2">
          ...
          {/* ICON DIUBAH MENJADI ICON GEMBOK (LOCKED STATE) */}
          <button className="w-11 h-11 rounded-full bg-[#E2E8F0] flex items-center justify-center text-gray-400 shadow-sm cursor-not-allowed">
